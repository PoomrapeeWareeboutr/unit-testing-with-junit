...
public class LocationServiceTest {
    ...
    class LocationServiceDeleteByIDTest {
        ...
        public void testDeleteByNegativeId(){
            // Test case 1: (-1, False)
            int targetID = -1;
            doThrow(new ObjectNotFoundException()).when(locationservice).deleteById(targetID);
            assertThrows(ObjectNotFoundException.class, () -> locationservice.deleteById(targetID));
        }
        @Test
